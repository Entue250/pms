                    ...
                    <div class="card-body">
                        <% if(request.getParameter("error") != null) { %>
                            <div class="alert alert-danger">
                                <%= request.getAttribute("errorMessage") != null ? request.getAttribute("errorMessage") : "Error registering doctor. Please try again." %>
                            </div>
                        <% } %>
                        
                        <form action="../../registerDoctor" method="post" class="needs-validation" novalidate>
                            <div class="row mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="doctors.jsp" class="btn btn-secondary me-md-2">Cancel</a>
