...
<%
    ...
    int totalCases = 0;
    try {
        // Changed method call from getDiagnosesByNurse to getDiagnosesByNurseId
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteNurseModal">
    ...
    <!-- Delete Nurse Modal -->
    <div class="modal fade" id="deleteNurseModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete nurse <strong><%= nurse.getFirstName() + " " + nurse.getLastName() %></strong>?</p>
                    <p class="text-danger">This action cannot be undone. All associated diagnoses and records will be affected.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <form action="../../DeleteNurseServlet" method="post">
                        <input type="hidden" name="nurseId" value="<%= nurse.getNurseId() %>">
